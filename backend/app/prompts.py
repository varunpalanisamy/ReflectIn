def get_prompt_for_reflection(score: int, user_message: str) -> str:
    ...
    if score in [1, 2]:
        return (
            ...
            f"Now, write a gentle, emotionally supportive reflection prompt to help them process this. Limit your response to 50-100 words. "
        )
    elif score in [3, 4]:
        return (
            ...
            f"User message:\n{user_message}\n\n"
            f"Respond with a thoughtful, open-ended question for reflection. Limit your response to 50-100 words. "
        )
    elif score in [5, 6]:
        return (
            ...
            f"User message:\n{user_message}\n\n"
            f"Write a simple reflective question to help them make sense of their emotions. Limit your response to 50-100 words. "
        )
    elif score in [7, 8]:
        return (
            ...
            f"User message:\n{user_message}\n\n"
            f"Create a reflection prompt that celebrates progress while inspiring growth. Limit your response to 50-100 words. "
        )
    elif score in [9, 10]:
        return (
            ...
            f"User message:\n{user_message}\n\n"
            f"Write a short positive reflection question to help them stay grounded and motivated. Limit your response to 50-100 words. "
        )
    else:
        return (
            f"Act as a thoughtful guide. Help the user reflect on their emotions with compassion.\n\n"
            f"User message:\n{user_message}\n\n"
            f"Write a reflection prompt that helps them better understand how they feel. Limit your response to 50-100 words. "
        )
